...
| `bunkerweb.tag`                                      | Configuration for tag                                                                                   | `string` | `"1.6.14"`                                              |
...
| `ui.tag`                                      | Configuration for tag                                                                                   | `string` | `"1.6.14"`                                                                 |
...
| `scheduler.tag`                                                       | Configuration for tag                                                                                   | `string` | `"1.6.14"`                                                  |
...
| `scheduler.features.metrics.metricsRedisTtl`                          | TTL in seconds for metrics keys in Redis (0 keeps them permanent, accepts k/m suffix). Refreshed on ... | `string` | `""`                                                        |
...
| `controller.tag`                                      | Configuration for tag                                                                                   | `string` | `"1.6.14"`                                                 |
...
| `api.tag`                                      | Configuration for tag                                                                                   | `string` | `"1.6.14"`                                            |
